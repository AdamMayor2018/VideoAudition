...
from ensembles.detect.yolov5.utils.general import xywh2xyxy, xyxy2xywh
#from ensembles.detect.yolov5.utils.metrics import fitness
...
def output_to_target(output):
    # Convert ensembles output to target format [batch_id, class_id, x, y, w, h, conf]
    targets = []
...
def plot_study_txt(path='study/', x=None):  # from utils.plots import *; plot_study_txt()
    # Plot study.txt generated by ffmpeg_test_non_sysnc.py
